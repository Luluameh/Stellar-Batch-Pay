            ...
            <div className="text-center hidden md:block lg:text-left space-y-8 max-h-screen">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-400 text-sm">
                      Credentials are encrypted and securely processed with
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-400 text-sm">
                      Manage payments anytime, anywhere with secure dashboard
                      access.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-400 text-sm">
                      Track transactions and monitor payment status in
                      real-time.
                    </p>
                  </div>
                </div>
              ...
              <div className="text-center lg:text-left">
                <p className="text-gray-500 text-xs">
                  <span>
                    <Lock className="w-4 h-4 inline mr-1 fill-current" />
                  </span>
              ...
              <div className="space-y-6">
                ...
                <div className="w-full justify-center items-center flex rounded-md text-center bg-[#37415180]/30 h-[54px] border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white transition-all duration-200">
                  <p className="text-gray-500 text-xs flex">
                    <Shield className="w-3 h-3  mr-2 text-green-400" /> Your
                    credentials are encrypted and securely processed.
                  </p>
                </div>
              </div>
            </div>
